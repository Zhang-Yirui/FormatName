<template>
  <header class="fn-header" :class="{'is-dark': dark}">
    ...
    <div class="fn-header__actions">
      ...
      >
        <span class="fn-icon">
          <!-- 太阳：浅色模式 -->
          <svg v-if="dark" viewBox="0 0 32 32" aria-hidden="true">
            <g fill="currentColor">
              <circle cx="16" cy="16" r="6"/>
              <rect x="15" y="2" width="2" height="4.5" rx="1"/>
              <rect x="15" y="25.5" width="2" height="4.5" rx="1"/>
              <rect x="2" y="15" width="4.5" height="2" rx="1"/>
              <rect x="25.5" y="15" width="4.5" height="2" rx="1"/>
              <rect x="15" y="2" width="2" height="4.5" rx="1" transform="rotate(45 16 16)"/>
              <rect x="15" y="2" width="2" height="4.5" rx="1" transform="rotate(-45 16 16)"/>
              <rect x="15" y="2" width="2" height="4.5" rx="1" transform="rotate(135 16 16)"/>
              <rect x="15" y="2" width="2" height="4.5" rx="1" transform="rotate(-135 16 16)"/>
            </g>
          </svg>
          <!-- 月亮：深色模式 -->
